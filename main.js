...
projects.forEach((project) => {
  ...
  oneProject.innerHTML = `
    <a href="${project.project_link}" data-link target="_blank" class="work-list-item-inner">
      <img class="work-picture" src="${project.project_picture}" alt="${project.title}-illustration">
    </a>

    <h4 class="work-list-item-title">
      <a href="${project.project_link}" data-link target="_blank" data-title="${project.title}"></a>
    </h4>

    <p class="work-list-item-role">${project.role}</p>

    <a href="${project.github_source_code}" data-link target="_blank" class="button">
